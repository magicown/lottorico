...
<div class="miso-outlogin">
	...
	<?php } else { //Logout ?>
		...
		<input type="hidden" name="url" value="<?php echo $urlencode; ?>">
			<div class="form-group">	
				<div class="input-group" style="height:50px !important;">
					...
					<input type="text" name="mb_id" class="form-control input-sm" placeholder="아이디" tabindex="21" style="height:50px !important;">
				</div>
			</div>
			<div class="form-group">	
				<div class="input-group" style="height:50px !important;">
					<span class="input-group-addon"><i class="fa fa-lock gray"></i></span>
					<input type="password" name="mb_password" class="form-control input-sm" placeholder="비밀번호" tabindex="22" style="height:50px !important;">
				</div>
			</div>
			<div class="form-group">
				<button type="submit" class="btn btn-<?php echo $btn_login;?> btn-block en" tabindex="23"  style="height:50px !important; ">
		...
		<?php if(function_exists('apms_social_login_icon')) echo apms_social_login_icon(); //소셜로그인 아이콘 ?>
		<script>
