...
<h3 class="poll-head">
	<i class="fa fa-quote-left"></i> <?php echo $po_subject ?> 결과 <i class="fa fa-quote-right"></i>
</h3>

<div style="padding:30px;">
	<ul class="list-group">
		<li class="list-group-item text-center" style="background:#fafafa;">
			<b class="list-group-item-heading"><i class="fa fa-smile-o fa-lg"></i> 전체 <?php echo $nf_total_po_cnt ?>표</b>
		</li>
		<?php for ($i=1; $i<=count($list); $i++) {  ?>
			<li class="list-group-item">
				<p class="list-group-item-heading"><b><?php echo $list[$i]['content'] ?></b></p>
			...
			<div class="panel panel-default" style="margin-top:10px;">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<input type="text" id="pc_idea" name="pc_idea" required class="form-control input-sm" size="47" maxlength="100"  placeholder="의견">
					</div>
	...
	<div class="panel panel-default">
		...
		<div class="list-group">
			<?php for ($i=0; $i<count($list3); $i++) {  ?>
				<a href="./poll_result.php?po_id=<?php echo $list3[$i]['po_id'] ?>" class="list-group-item">
