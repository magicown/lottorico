...
<div id="bo_w" class="write-wrap box-colorset<?php echo (G5_IS_MOBILE) ? ' box-colorset-mobile' : '';?>">
	...
	<?php if ($is_email) { ?>
		<div class="form-group has-feedback">
			...
			<div class="col-sm-5">
                <input type="text" name="qa_email" value="<?php echo $write['qa_email']; ?>" id="qa_email" <?php echo $req_email; ?> class="form-control input-sm email" size="50" maxlength="100">
	...
	<?php if ($is_hp) { ?>
		<div class="form-group has-feedback">
			...
			<div class="col-sm-5">
                <input type="text" name="qa_hp" value="<?php echo $write['qa_hp']; ?>" id="qa_hp" <?php echo $req_hp; ?> class="form-control input-sm" size="30">
