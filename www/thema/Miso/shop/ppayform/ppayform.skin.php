...
<section id="sod_frm_pay" style="margin-bottom:0px;">
	<div class="panel panel-default">
		<div class="panel-heading"><strong><i class="fa fa-user"></i> 개인결제정보</strong></div>
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<?php } else { ?>
						<?php if($is_vbank) { ?>
							<label class="btn btn-white btn-sm"><input type="radio" id="pp_settle_vbank" name="pp_settle_case" value="가상계좌"> <?php echo $escrow_title;?>가상계좌</label><?php } ?>

						<?php if($is_iche) { ?>
							<label class="btn btn-white btn-sm"><input type="radio" id="pp_settle_iche" name="pp_settle_case" value="계좌이체"> <?php echo $escrow_title;?>계좌이체</label>
						<?php } ?>

						<?php if($is_hp) { ?>
							<label class="btn btn-white btn-sm"><input type="radio" id="pp_settle_hp" name="pp_settle_case" value="휴대폰"> 휴대폰</label>
						<?php } ?>

						<?php if($is_card) { ?>
							<label class="btn btn-white btn-sm"><input type="radio" id="pp_settle_card" name="pp_settle_case" value="신용카드"> 신용카드</label>
						<?php } ?>
					<?php } ?>
				</div>
			</div>
