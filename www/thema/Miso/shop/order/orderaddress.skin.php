...
<div id="sod_addr">
	<div class="table-responsive">
		...
		<tr class="active">
            ...
            <th class="text-center" scope="col">배송지명</th>
            <th class="text-center" scope="col">기본</th>
        ...
        <?php for($i=0; $i < count($list); $i++) { ?>
			<tr>
				...
				<td class="text-center">
					...
					<button type="button" class="sel_address btn btn-black btn-xs" title="선택"><i class="fa fa-check fa-lg"></i><span class="sound_only">선택</span></button>
