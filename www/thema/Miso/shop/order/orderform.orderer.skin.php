...
<?php if(!$is_orderform) { //주문서가 필요없는 주문일 때 ?>
	...
	<section id="sod_frm_orderer" style="margin-bottom:0px;">
		<div class="panel panel-default">
			<div class="panel-heading"><strong><i class="fa fa-user"></i> 결제하시는 분</strong></div>
			<div class="panel-body">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-3">
						<input type="text" name="od_name" value="<?php echo $member['mb_name']; ?>" id="od_name" required class="form-control input-sm" maxlength="20">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-3">
						<input type="text" name="od_tel" value="<?php echo ($member['mb_hp']) ? $member['mb_hp'] : $member['mb_tel']; ?>" id="od_tel" required class="form-control input-sm" maxlength="20">
				...
				<input type="hidden" name="od_hp" value="<?php echo $member['mb_hp']; ?>">
				<input type="hidden" name="od_b_name" value="<?php echo $member['mb_name']; ?>">
				<input type="hidden" name="od_b_tel" value="<?php echo $member['mb_tel']; ?>">
				<input type="hidden" name="od_b_hp" value="<?php echo $member['mb_hp']; ?>">
				<input type="hidden" name="od_b_zip1" value="<?php echo $member['mb_zip1']; ?>">
				<input type="hidden" name="od_b_zip2" value="<?php echo $member['mb_zip2']; ?>">
				<input type="hidden" name="od_b_addr1" value="<?php echo $member['mb_addr1']; ?>">
				<input type="hidden" name="od_b_addr2" value="<?php echo $member['mb_addr2']; ?>">
			</div>
		</div>
	</section>
...
<?php } else { ?>
	...
	<section id="sod_frm_orderer" style="margin-bottom:0px;">
		<div class="panel panel-default">
			<div class="panel-heading"><strong><i class="fa fa-user"></i> 주문하시는 분</strong></div>
			<div class="panel-body">
				<div class="form-group has-feedback">
					<label class="col-sm-2 control-label" for="od_name"><b>이름</b><strong class="sound_only">필수</strong></label>
					<div class="col-sm-3">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-3">
						<input type="text" name="od_tel" value="<?php echo $member['mb_tel']; ?>" id="od_tel" required class="form-control input-sm" maxlength="20">
						<span class="fa fa-phone form-control-feedback"></span>
					</div>
				</div>
				<div class="form-group has-feedback">
					...
					<div class="col-sm-3">
						<input type="text" name="od_hp" value="<?php echo $member['mb_hp']; ?>" id="od_hp" class="form-control input-sm" maxlength="20">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-8">
						...
						<label>
							<input type="text" name="od_zip1" value="<?php echo $member['mb_zip1'] ?>" id="od_zip1" required class="form-control input-sm" size="3" maxlength="3">
						</label>
						<label>-</label>
						<label for="od_zip2" class="sound_only">우편번호 뒷자리<strong class="sound_only"> 필수</strong></label>
						<label>
							<input type="text" name="od_zip2" value="<?php echo $member['mb_zip2'] ?>" id="od_zip2" required class="form-control input-sm" size="3" maxlength="3">
						</label>
						<label>
		                    <button type="button" class="btn btn-black btn-sm" style="margin-top:0px;" onclick="win_zip('forderform', 'od_zip1', 'od_zip2', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon');">주소 검색</button>
						</label>

						<div class="addr-line">
							<label class="sound_only" for="od_addr1">기본주소<strong class="sound_only"> 필수</strong></label>
							<input type="text" name="od_addr1" value="<?php echo $member['mb_addr1'] ?>" id="od_addr1" required class="form-control input-sm" size="60" placeholder="기본주소">
						</div>

						<div class="addr-line">
							<label class="sound_only" for="od_addr2">상세주소</label>
							<input type="text" name="od_addr2" value="<?php echo $member['mb_addr2'] ?>" id="od_addr2" class="form-control input-sm" size="50" placeholder="상세주소">
						</div>

						<label class="sound_only" for="od_addr3">참고항목</label>
						<input type="text" name="od_addr3" value="<?php echo $member['mb_addr3'] ?>" id="od_addr3" class="form-control input-sm" size="50" readonly="readonly" placeholder="참고항목">
	...
	<section id="sod_frm_taker">
		<div class="panel panel-default">
			<div class="panel-heading"><strong><i class="fa fa-truck"></i> 받으시는 분</strong></div>
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<?php if($is_member) { ?>
							...
							<?php if($addr_default) { ?>
								<label class="btn btn-white btn-sm">
									<input type="radio" name="ad_sel_addr" value="<?php echo $addr_default;?>" id="ad_sel_addr_def">
									기본배송지
								</label>
							<?php } ?>
							...
							<?php for($i=0; $i < count($addr_sel); $i++) { ?>
								<label class="btn btn-white btn-sm">
									<input type="radio" name="ad_sel_addr" value="<?php echo $addr_sel[$i]['addr'];?>" id="ad_sel_addr_<?php echo $i+1;?>">
									최근배송지<?php echo ($addr_sel[$i]['name']) ? '('.$addr_sel[$i]['name'].')' : '';?>
								</label>
							<?php } ?>
							<label class="btn btn-white btn-sm">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-8">
						...
						<label>
							<input type="text" name="od_b_zip1" id="od_b_zip1" required class="form-control input-sm" size="3" maxlength="3">
						</label>
						<label>-</label>
						<label for="od_b_zip2" class="sound_only">우편번호 뒷자리<strong class="sound_only"> 필수</strong></label>
						<label>
							<input type="text" name="od_b_zip2" id="od_b_zip2" required class="form-control input-sm" size="3" maxlength="3">
						</label>
						<label>
							<button type="button" class="btn btn-black btn-sm" style="margin-top:0px;" onclick="win_zip('forderform', 'od_b_zip1', 'od_b_zip2', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');">주소 검색</button>
						</label>
