...
while($rs = sql_fetch_array($res)){
    $que = "UPDATE g5_member SET mb_1 = '', mb_3 = '',mb_4 = '',mb_10='', mon_sms_cnt = '0', mon_sms_cnt = '0', tue_sms_cnt = '0', wed_sms_cnt = '0', thu_sms_cnt = '0', fri_sms_cnt = '0', sat_sms_cnt = '0' WHERE mb_id = '{$rs['mb_id']}'";
    echo $que."<br>";
    sql_query($que);
