...
<div id="wrap">
  ...
  <div class="landing_content_wrap">
      ...
      <div class="content">
        <input type="text" name="name" placeholder="성함을 입력하세요!"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="11" /><br />
 ...
 <a href="http://www.lottorico.co.kr"><img src="images/06.jpg" /></a>
        ...
        $('#getFreeNum').on('click',function(){
            ...
            if(hp == ''){
                ...
                $.ajax({
                    type: "POST",
                    url: "../ajax.php",
                    data: {mode: "freeCounselor", hp: hp, type : 'L'},
                    dataType: "json",
