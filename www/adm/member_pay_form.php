        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <input type="radio" name="pay_chk" class="pay_grade" data-pay_name="<?php echo $pay['pay_name']; ?>" data-pay_money="<?php echo number_format($pay['pay_money']); ?>" value="<?php echo $pay['idx'];?>"><?php echo $pay['pay_name']; ?>(<?php echo number_format($pay['pay_money']); ?>원)
                            <br>
                    <?php } ?>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="radio" name="pay_type" class="pay_type" data-pay_type="bank" value="bank" onclick="show_type('bank');">무통장
                    <input type="radio" name="pay_type" class="pay_type"  data-pay_type="card" value="card" checked onclick="show_type('card');">신용카드
                    <input type="radio" name="pay_type" class="pay_type"  data-pay_type="hp" value="hp">휴대폰
                    <input type="radio" name="pay_type" class="pay_type"  data-pay_type="payup" value="payup">페이업
                </td>
            </tr>
            <tr>
                <td colspan="5">
...
<!--무통장 결제-->
<div class="tbl_frm01 tbl_wrap" id="pay_type_bank" style="display: none;">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    while($pay = sql_fetch_array($res_pay)){
                        ?>
                        <input type="radio" name="pay_chk1" class="pay_grade" data-pay_name="<?php echo $pay['pay_name']; ?>" data-pay_money="<?php echo number_format($pay['pay_money']); ?>" value="<?php echo $pay['idx'];?>"><?php echo $pay['pay_name']; ?>(<?php echo number_format($pay['pay_money']); ?>원)
                        <br>
                    <?php } ?>
                </td>
            </tr>
            ...
            <tr>
                <th scope="row"><label for="mb_10">결제방식선택</label></th>
                <td colspan="3">
                    <input type="radio" name="pay_type" class="pay_type"  data-pay_type="bank" value="bank" onclick="show_type('bank');" checked>무통장
                    <input type="radio" name="pay_type" class="pay_type"  data-pay_type="card" value="card" onclick="show_type('card');">신용카드
                    <input type="radio" name="pay_type" class="pay_type"  data-pay_type="hp" value="hp">휴대폰
                    <input type="radio" name="pay_type" class="pay_type"  data-pay_type="payup" value="payup">페이업
                </td>
            </tr>
