...
sql_query(" ALTER TABLE `{$g5['apms_xp']}` ADD `video_img` tinyint(4) NOT NULL DEFAULT '0' AFTER `editor_img` ", false);
sql_query(" ALTER TABLE `{$g5['apms_xp']}` ADD `comment_limit` int(11) NOT NULL DEFAULT '0' AFTER `video_img` ", false);
...
$PHtml[] = array('reg', 'bbs/register.php', '회원가입', '{아이콘:sign-in} 무료회원가입', '회원가입안내');
