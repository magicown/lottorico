...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        <th scope="col">번호</th>
        <th scope="col" style="width:200px;">상품코드</th>
        <th scope="col" style="width:200px;">회원아이디</th>
        <th scope="col" style="width:200px;">상품명</th>
        <th scope="col" style="width:200px;">구매자</th>
        <th scope="col" style="width:200px;">연락처1</th>
        <th scope="col" style="width:200px;">이메일</th>
        <th scope="col" style="width:200px;">상품명</th>
        <th scope="col" style="width:200px;">승인일자</th>
        <th scope="col" style="width:200px;">fnCd</th>
        <th scope="col" style="width:200px;">카드사</th>
        <th scope="col" style="width:200px;">결과코드</th>
        <th scope="col" style="width:200px;">결과메세지</th>
        <th scope="col" style="width:200px;">카드종료일</th>
        <th scope="col" style="width:200px;">ediDate</th>
        <th scope="col">관리</th>
    </tr>
    </thead>
    <tbody>
