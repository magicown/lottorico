...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_id" class="td_name sv_use">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#memoModal" data-whatever="@mdo">메모</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="exampleModalLabel"><?php echo $row['mb_nick']; ?> 메모 입력</h4>
                        </div>
                        <div class="modal-body">
                            <form>
                                <div class="form-group">
                                    <textarea class="form-control" id="message-text" rows="10"><?php echo $row['mb_memo']; ?></textarea>
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default btn-closed" data-dismiss="modal">닫기</button>
                            <button type="button" class="btn btn-primary" id="memo_save" data-mbid="<?php echo $row['mb_id']; ?>">저장</button>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function(){
    $('#memo_save').on('click',function(){
        var mb_memo = $('#message-text').val();
        var jsonurl =  "./member_proc.php";

        $.ajax({
            type : "POST",
            url : jsonurl,
            dataType :  "JSON",
            data : {"mode" : "writeMemo", "mb_id" : $(this).data('mbid'), "mb_memo" : mb_memo},
