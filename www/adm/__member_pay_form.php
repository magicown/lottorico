    ...
    <form name="fmember2" id="fmember2" action="./pay_bank_proc.php"  onsubmit="return fmember_submit2(this);" target="hiddenFrm" method="post" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                <th scope="row"><label for="mb_id">성명<?php echo $sound_only ?></label></th>
                <td>
                    <input type="text" name="mb_name" value="<?php echo $mb['mb_name'] ?>" required id="mb_name"class="frm_input <?php echo $required_mb_id_class ?>" size="15" minlength="3" maxlength="20">
                    <?php if ($w=='u'){ ?><a href="./boardgroupmember_form.php?mb_id=<?php echo $mb['mb_id'] ?>">접근가능그룹보기</a><?php } ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    계좌정보 <input type="text" name="bank_num" required  id="bank_num"  class="frm_input" size="50" maxlength="20"  value="국민은행 224601-04-228351" readonly>
                </td>
            ...
            <tr>
                <th scope="row"><label for="mb_hp">결제정보</label></th>
                <td>
                    상품명 <input type="text" name="pay_name" required  id="pay_name" class="frm_input" size="30" maxlength="20" >
                    금액 <input type="text" name="pay_money" required  id="pay_money" class="frm_input" size="15" maxlength="20" >
                </td>
            </tr>
