...
<div class="tbl_frm01 tbl_wrap">
            ...
            <td colspan="3">
                ...
                for($i=1;$i<=6;$i++){
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="mb_1" value="<?php echo $i; ?>" <?php echo ($mb['mb_1']==$i)?'checked':''; ?>> <?php echo $day_name; ?>
    ...
    <tr>
        ...
        <td colspan="3"><input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" class="frm_input" size="30" maxlength="255" readonly> (무료회원 2개월도 포함됩니다.)</td>
    </tr>
    <tr>
        <th scope="row"><label for="mb_3">받을 문자 갯수</label></th>
        <td colspan="3"><input type="number" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" class="frm_input" size="10" > (숫자만 입력가능 합니다. 최대 사용가능 숫자는 1,000입니다.)</td>
    </tr>
	<tr>
