...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" style="width:200px;">order_id</th>
        <th scope="col" style="width:200px;">결제금액</th>
        <th scope="col" style="width:200px;">구매일자</th>
        <th scope="col" style="width:200px;">Transaction_id</th>
        <th scope="col" style="width:200px;">결과코드</th>
        <th scope="col" style="width:200px;">결과값</th>
        <th scope="col" style="width:200px;">상세코드</th>
        <th scope="col" style="width:200px;">결과메세지</th>
        <th scope="col" style="width:200px;">idate</th>
        <th scope="col" style="width:200px;">Card/HP</th>
        <th scope="col">관리</th>
    </tr>
    </thead>
    <tbody>
