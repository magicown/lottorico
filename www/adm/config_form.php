...
if(!isset($config['cf_member_img_size'])) {
    ...
    $config['cf_member_img_width'] = 80;
    $config['cf_member_img_height'] = 80;
}
		...
		<tr>
            ...
            <td>
				...
				for ($i=0; $i<count($arr); $i++) {
                    echo "<option value=\"".$arr[$i]."\"".get_selected($admin_skin, $arr[$i]).">".$arr[$i]."</option>\n";
                }
                ?>
                </select>
            </td>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_extra">
                ...
                <input type="text" name="cf_<?php echo ($i == 8) ? $i.'_old' : $i; ?>" value="<?php echo get_sanitize_input($config['cf_'.$i]); ?>" id="cf_<?php echo $i ?>" class="frm_input" size="30">
            </td>
        </tr>
        <?php } ?>
        </tbody>
