...
//날짜검색
if($fr_date || $to_date){
    $sql_search .= " and DATE_FORMAT(mb_datetime,'%Y-%m-%d') BETWEEN '{$fr_date}' AND '{$to_date}' ";
}
//등급검색
if($member_grade1){
    if($member_grade1 == '1'){
        $sql_search .= " and mb_10 = '' ";
    } else {
    ...
    <div class="tbl_head01 tbl_wrap">
        <table>
            ...
            for ($i=0; $row=sql_fetch_array($result); $i++) {
                ...
                $que = "SELECT COUNT(*) as cnt FROM member_lotto_num WHERE lotto_turn = '{$now_turn}' AND mb_id = '{$row['mb_id']}' AND direct_send = 'N' ";
                //echo $que."<br>";
