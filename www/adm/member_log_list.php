...
$g5['title'] = '회원등급변경 로그 (최고관리자만 사용가능)';
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" style="width:200px;">변경전 등급</th>
        <th scope="col" style="width:200px;">변경후 등급</th>
        <th scope="col" style="width:200px;">변경자 아이디</th>
        <th scope="col">일시</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_datetime"><input type="button" value="회원정보 이동" class="btn btn_03" onclick="location.href='/adm/member_form.php?w=u&mb_id=<?php echo $row[log_mb_id]; ?>';"></td>
    </tr>
