...
$fail = 0;
$que = "SELECT * FROM g5_member WHERE mb_10 < 3 AND mb_hp != '' AND mb_leave_date = '' AND mb_10 = '2' AND mb_1 = '5' AND mb_2 > DATE_FORMAT(NOW(), '%Y-%m-%d') AND mb_2 != '' ";
//echo $que."<br>";
